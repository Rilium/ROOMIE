      ...
      <div className="session-shell roomie-shell">
        ...
        {sessionFriends.length === 0 && isLive && (
          <section className="session-friends-card">
            <div className="session-friends-head">
              <div>
                <div className="in-room-kicker">GRUPPO IN ROOM</div>
                <div className="session-friends-title">Solo host</div>
              </div>
              <span>Live</span>
            </div>
        ...
        <section className="control-room-card">
          ...
          <div className="control-room-grid">
            ...
            <button className="control-room-action is-urgent" type="button" onClick={() => showToast({ title: 'Assistenza avvisata', copy: 'Il team riceve sessione, orario e stato accesso.' })}>
            ...
            <button className="control-room-action" type="button" onClick={copyWifi}>
            ...
            <button className="control-room-action is-wide" type="button" onClick={() => showPage('confirm')}>
              <span className="control-room-icon"><i className="fas fa-receipt"></i></span>
              <span className="control-room-copy">
                <strong>Dettagli prenotazione</strong>
                <small>{booking ? `${booking.date} · ${booking.start}-${booking.end}` : 'Riepilogo accesso e codici'}</small>
              </span>
              <span className="control-room-meta"><i className="fas fa-chevron-right"></i></span>
            </button>
          </div>
